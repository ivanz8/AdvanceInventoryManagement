          ...
          <!-- Filter Dropdown -->
            ...
            <label for="category" class="mr-2 font-medium text-gray-700 dark:text-gray-300">Filter by Category:</label>
              <select
                ...
                id="category"
                class="bg-transparent border dark:border-gray-600 rounded px-3 py-2 text-gray-700 dark:text-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              >
